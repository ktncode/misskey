...
export type AdminRelaysAcceptLitepubRequest = operations['admin___relays___accept-litepub']['requestBody']['content']['application/json'];
...
export type AdminRelaysAddLitepubRequest = operations['admin___relays___add-litepub']['requestBody']['content']['application/json'];
export type AdminRelaysHasPendingResponse = operations['admin___relays___has-pending']['responses']['200']['content']['application/json'];
export type AdminRelaysListResponse = operations['admin___relays___list']['responses']['200']['content']['application/json'];
export type AdminRelaysListLitepubResponse = operations['admin___relays___list-litepub']['responses']['200']['content']['application/json'];
export type AdminRelaysRejectLitepubRequest = operations['admin___relays___reject-litepub']['requestBody']['content']['application/json'];
export type AdminRelaysRemoveRequest = operations['admin___relays___remove']['requestBody']['content']['application/json'];
export type AdminRelaysRemoveLitepubRequest = operations['admin___relays___remove-litepub']['requestBody']['content']['application/json'];
