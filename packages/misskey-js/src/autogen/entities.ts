...
export type FollowingActivitiesRequest = operations['following___activities']['requestBody']['content']['application/json'];
export type FollowingActivitiesResponse = operations['following___activities']['responses']['200']['content']['application/json'];
