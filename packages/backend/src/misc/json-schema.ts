...
import { packedLitePubRelaySchema, packedMastodonRelaySchema } from '@/models/json-schema/relay.js';
...
export const refs = {
	...
	MastodonRelay: packedMastodonRelaySchema,
	LitePubRelay: packedLitePubRelaySchema,
};
