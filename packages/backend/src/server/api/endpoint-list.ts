...
export * as 'admin/relays/accept-litepub' from './endpoints/admin/relays/accept-litepub.js';
export * as 'admin/relays/add' from './endpoints/admin/relays/add.js';
export * as 'admin/relays/add-litepub' from './endpoints/admin/relays/add-litepub.js';
export * as 'admin/relays/has-pending' from './endpoints/admin/relays/has-pending.js';
export * as 'admin/relays/list' from './endpoints/admin/relays/list.js';
export * as 'admin/relays/list-litepub' from './endpoints/admin/relays/list-litepub.js';
export * as 'admin/relays/reject-litepub' from './endpoints/admin/relays/reject-litepub.js';
export * as 'admin/relays/remove' from './endpoints/admin/relays/remove.js';
export * as 'admin/relays/remove-litepub' from './endpoints/admin/relays/remove-litepub.js';
