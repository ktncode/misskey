...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
		...
		super(meta, paramDef, async (ps, me, token) => {
			...
			if (profile.followersVisibility !== 'public' && !await this.roleService.isModerator(me, token)) {
			...
			return await this.followingEntityService.packMany(followings, me, token, { populateFollower: true });
		});
	}
}
