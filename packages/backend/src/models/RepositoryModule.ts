...
const $followingLogsRepository: Provider = {
	provide: DI.followingLogsRepository,
	useFactory: (db: DataSource) => db.getRepository(MiFollowingLog).extend(miRepository as MiRepository<MiFollowingLog>),
	inject: [DI.db],
};
